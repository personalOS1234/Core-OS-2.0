...
def menu_initialization(coreObject, quequeObject, menuFunction, thread_name = 'uknown'):
    """
    :param thread_name: name of adding thread
    ...
    """
    coreObject.addThread(menuFunction, quequeObject, threadName = thread_name)
